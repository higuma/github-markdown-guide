...
GitHubでは以前より独自のMarkdown構文を用いた表組みの機能が実装されている。その後他のMarkdown実装にも採用され、現在では多くのMarkdown環境で利用可能な機能になっている。本章は[GitHub Markdown環境]をリファレンスとし、その仕様と動作について詳しく解説する。
...
**注意**: 以下の内容は[GitHub Markdown環境]で実環境確認したもので、他のMarkdown環境では動作が異なる事が多い点に留意すること。
